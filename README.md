...
### v1 — Hackathon MVP (March 2026) ✅
- ✅ P2P dispute creation with custom deadlines
- ✅ TON Connect wallet integration
- ✅ On-chain deposit verification
- ✅ AI Auto-Arbiter with OpenAI + Tavily
- ✅ Anonymous community oracle with 3 arbiters
- ✅ Automatic TON payouts
- ✅ Referral system with automatic rewards
- ✅ Premium arbiter program for core operators
- ✅ Telegram Mini App with end-to-end dispute flow
- ✅ Self-test and runtime health monitoring
